...
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I am tailor and designer extraordinaire. Well, rather a designer. I leave most of the actual tailoring to my assistants." })
