...
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I have an incredible assortment of weapons and armor for sale. Just ask me for a trade." })
