...
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, text = "Well, YOU are the news. The desert had told us about a foreigner who would come." })
keywordHandler:addKeyword({ "excalibug" }, StdModule.say, { npcHandler = npcHandler, text = "Is that a weapon? We only use scimitars." })
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, { npcHandler = npcHandler, text = "I am surprised you know about him! There is an old story that is told from generation to generation in order to prepare us for the hardest challenge the true sons have to face. I hope it will never happen." })
keywordHandler:addKeyword({ "tibia" }, StdModule.say, { npcHandler = npcHandler, text = "We have no interest in other regions. Our land is Darama - the desert." })
keywordHandler:addKeyword({ "carlin" }, StdModule.say, { npcHandler = npcHandler, text = "I would go crazy living in a cage like that." })
keywordHandler:addKeyword({ "thais" }, StdModule.say, { npcHandler = npcHandler, text = "I would go crazy living in a cage like that." })
keywordHandler:addKeyword({ "king" }, StdModule.say, { npcHandler = npcHandler, text = "If someone claims to be our king, he should come here and tell us personally." })
keywordHandler:addKeyword({ "time" }, StdModule.say, { npcHandler = npcHandler, text = "Time is of no importance for us." })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "My whole name is Muhad ib Lisan al-Gaib. But my people call me simply Muhad." })
