...
keywordHandler:addKeyword({ "time" }, StdModule.say, { npcHandler = npcHandler, text = "Currently it is 6:44 pm." })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "My name is Chantalle." })
