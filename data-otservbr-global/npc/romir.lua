...
keywordHandler:addKeyword({ "gods" }, StdModule.say, { npcHandler = npcHandler, text = "The eyes of the gods certainly rest even on this icy place." })
keywordHandler:addKeyword({ "monsters" }, StdModule.say, { npcHandler = npcHandler, text = "My spells keep most monsters at bay. Not that many would come close to Svargrond anyway." })
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, text = "If I cared about news, I hadn't chosen this remote spot to settle down." })
keywordHandler:addKeyword({ "excalibug" }, StdModule.say, { npcHandler = npcHandler, text = "There is no legend that connects excalibug with the north. I suggest to continue your search somewhere else." })
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, { npcHandler = npcHandler, text = "One has to admit the power he accumulated is awesome and he even left mortality behind." })
keywordHandler:addKeyword({ "carlin" }, StdModule.say, { npcHandler = npcHandler, text = "Carlin is probably more tolerable than Thais but I am no friend of cities in general." })
keywordHandler:addKeyword({ "thais" }, StdModule.say, { npcHandler = npcHandler, text = "Thais is a good example why people should become hermits." })
keywordHandler:addKeyword({ "king" }, StdModule.say, { npcHandler = npcHandler, text = "Not even the king's arm reaches this remote place." })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "I am known as Romir." })
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I guess one could call me a hermit. I am a bit new to this hermit business though and I have to admit I enjoy some company now and then. I also earn some money by teaching spells to those in search of knowledge." })
