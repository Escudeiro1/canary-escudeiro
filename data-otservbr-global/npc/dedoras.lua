...
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I was with the Inquisition for many years, until I left to pursue my own agendas." })
