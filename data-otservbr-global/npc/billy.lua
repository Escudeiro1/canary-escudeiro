...
-- Basic keywords
keywordHandler:addKeyword({ "monsters" }, StdModule.say, { npcHandler = npcHandler, text = "Don't be scared, you should be safe as long as you stay in town. Dangerous monsters are roaming the dungeons." })
