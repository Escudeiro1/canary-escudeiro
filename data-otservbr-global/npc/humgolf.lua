...
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, text = "Who needs news if the old things are still good enough? Humgolf Drilling licence" })
