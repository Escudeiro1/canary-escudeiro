...
keywordHandler:addKeyword({ "excalibug" }, StdModule.say, { npcHandler = npcHandler, text = "It is true that this weapon brings great power. But you should not look for power. It is wisdom you really need." })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "My name is Edala, pilgrim." })
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I am a mystic of the suns. I provide protective blessings for those in need." })
