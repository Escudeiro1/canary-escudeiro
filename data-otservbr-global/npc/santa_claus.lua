...
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "or job Ho ho ho! You don't know Santa Claus? Never mind. You may ask me for a present." })
