...
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I was chosen by the spirits of the ancestors to serve the people as healer and spiritual leader." })
