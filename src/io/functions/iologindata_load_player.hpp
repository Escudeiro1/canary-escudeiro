...
public:
	...
	static void loadPlayerBountyClass(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static void loadPlayerWeeklyClass(const std::shared_ptr<Player> &player, DBResult_ptr result);
