...
public:
	...
	void playerSetFightModes(uint32_t playerId, FightMode_t fightMode, bool chaseMode, bool secureMode, uint8_t pvpMode);
	...
	void updateCreaturePvpSquare(const std::shared_ptr<Creature> &creature, bool show) const;
