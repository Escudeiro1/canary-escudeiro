...
public:
	...
	void sendCreatureStaticSquare(const std::shared_ptr<Creature> &creature, SquareColor_t color) const;
	void sendCreatureClearSquare(const std::shared_ptr<Creature> &creature) const;
